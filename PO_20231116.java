...
//Zad 1
//Napisz metodę statyczną capitalizeEverySecond, która przyjmuje jako 
//argument obiekt typu StringBuilder. Metoda ma zmienić każdą drugą 
//literę na wielką. Stwórz przypadek testowy.
class zad1{
...
//Zad 3
//Zdefiniuj klasę Car, która ma pola: brand, model i productionYear. Klasa powinna zawierać 
//dwa konstruktory: pierwszy przyjmujący wszystkie trzy parametry, a drugi tylko markę i model. 
//Drugi konstruktor powinien wywoływać pierwszy, przekazując mu domyślną wartość productionYear 
//jako aktualny rok.
class Car{
    public String brand;
    public String model;
...
//Zad 4
//Stwórz klasę bazową o nazwie Vehicle z polami: brand i model. Klasa ta powinna posiadać 
//konstruktor przyjmujący oba te parametry. Następnie stwórz klasę potomną o nazwie Car, 
//która dziedziczy po klasie Vehicle. Klasa Car powinna posiadać dodatkowe pole numberOfDoors. 
//Stwórz konstruktor dla klasy Car, który przyjmuje wszystkie trzy parametry i korzysta z konstruktora 
//klasy bazowej. Stwórz przypadek testowy.
class Vehicle{
    public String brand;
    public String model;
...
//1.Stwórz klasę bazową Vehicle z metodą drive, która wypisuje “The vehicle is moving.”. 
//Następnie stwórz klasę potomną Car, która nadopisuje metodę drive tak, by wypisywała “The car 
//is moving.”. Utwórz obiekt klasy Car i wywołaj jego metodę drive, aby zaobserwować wynik.
//2.Na bazie klasy Vehicle z poprzedniego podpunktu, w klasie Car, nadpisz metodę drive tak, 
//by wywoływała oryginalną metodę z klasy bazowej i dodatkowo wypisywała informacje specyficzne 
//dla klasy Car. Użyj słowa kluczowego super, aby wywołać metodę z klasy bazowej.
class Vehicle2{
    public void drive(){
...
//Zad 7
//Napisz statyczną metodę mergeArrays, która przyjmuje dwie tablice liczb całkowitych jako argumenty.
// Funkcja powinna zwrócić nową listę tablicową, która jest połączeniem obu pierwotnych tablic. 
//Na przykład, dla list tablicowych [1, 2, 3] i [4, 5, 6], funkcja powinna zwrócić [1, 2, 3, 4, 5, 6]. 
